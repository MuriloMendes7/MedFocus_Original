(function(global) {
    ...
    modal.innerHTML = \`
      <div class="modal-content editor-modal">
        <div class="modal-header">
          <h2>Criar Deck de \${type === 'simulado' ? 'Simulado' : 'Flashcards'}</h2>
        ...
        <div class="modal-body">
          ...
          <div class="editor-actions">
            <button id="addItemBtn" class="btn btn--primary">Adicionar \${type === 'simulado' ? 'Questão' : 'Carta'}</button>
  ...
  function addSimuladoItem(container) {
    ...
    itemDiv.innerHTML = \`
      <div class="item-header">
        <span class="item-number">Questão \${container.children.length + 1}</span>
  ...
  function addFlashcardItem(container) {
    ...
    itemDiv.innerHTML = \`
      <div class="item-header">
        <span class="item-number">Carta \${container.children.length + 1}</span>
        <button class="remove-item-btn" onclick="this.parentElement.parentElement.remove()">&times;</button>
      </div>
